...
const MapChart = () => {
  (async () => {
    let map;
    const data_path = `${(window.location.href.includes('unctad.org')) ? 'https://storage.unctad.org/2025-tariff_policy_story/' : (window.location.href.includes('localhost:80')) ? './' : 'https://unctad-infovis.github.io/2025-tariff_policy_story/'}assets/data/`;
